...
SG_ID="sg-0e46ce6da86ce403es"SG ID
...
do
    ...
    then
        ...
        IP=$(aws ec2 describe-instances --instance-ids $INSTANCE_ID --query "Reservations[0].Instances[0].PublicIpAddress" --output text)  # this command gives the public IP
